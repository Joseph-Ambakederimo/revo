...
SECRET_KEY = 'django-insecure-y&18_l#bj^f#)q4*8*qoiqh6$adwb8k%%l+2ckl*3m7laqa$5c'
...
# ALLOWED_HOSTS = ['wat365solution.co.uk', 'www.wat365solution.co.uk']
...
STATIC_DIRS = [os.path.join(BASE_DIR, 'revo/static')]
